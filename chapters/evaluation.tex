...
\begin{figure}
    ...
    \begin{subfigure}{.25\textwidth}
      \centering
        \adjincludegraphics[width=1\textwidth, trim={{.06\width} {.08\height} {.31\width} {.11\height}},clip]{figures/plots/interpolation_plot.pdf}
        \caption{}
        \label{fig:intmain}
    \end{subfigure}%
    \begin{subfigure}{.25\textwidth}
        \adjincludegraphics[width=1\textwidth, trim={{.06\width} {.08\height} {.31\width} {.11\height}},clip]{figures/plots/pc_plot.pdf}
        \caption{}
        \label{fig:pcplot}
    \end{subfigure}%
    \begin{subfigure}{.25\textwidth}
        \adjincludegraphics[width=1\textwidth, trim={{.06\width} {.08\height} {.31\width} {.11\height}},clip]{figures/plots/unipow_plot.pdf}
        \caption{}
        \label{fig:unipowplot}
    \end{subfigure}%
    \begin{subfigure}{.25\textwidth}
        \adjincludegraphics[width=1\textwidth, trim={{.06\width} {.08\height} {.31\width} {.11\height}},clip]{figures/plots/unifloor_plot.pdf}
        \caption{}
...
\FloatBarrier
\subsection{Zero-Day}
\todo{set correct Floatbarriers so layout looks nice.}
\begin{figure}
    \centering
    \begin{subfigure}{.5\textwidth}
      \centering
