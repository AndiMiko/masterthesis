...
\begin{figure}
    ...
    \begin{subfigure}{.5\textwidth}
      \centering
      \adjincludegraphics[width=0.9\textwidth, trim={{.07\width} {.55\height} {.73\width} {.25\height}},clip]{figures/test2_artifacts.png}
      \caption{}
      \label{fig:varianceEdgeCdfgrid}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
